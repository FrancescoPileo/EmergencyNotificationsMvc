...
public class LocalSQLiteDbHelper extends SQLiteOpenHelper {
    ...
    private static LocalSQLiteDbHelper mInstance = null;
    ...
    public static synchronized LocalSQLiteDbHelper getInstance(Context ctx) {

        // Use the application context, which will ensure that you
        // don't accidentally leak an Activity's context.
        // See this article for more information: http://bit.ly/6LRzfx
        if (mInstance == null) {
            Log.w("DB", "nuova istanza");
            mInstance = new LocalSQLiteDbHelper(ctx.getApplicationContext());
        }
        return mInstance;
    }
    ...
    public boolean importAppuser(User user){
        ...
        if (user != null) {
            ...
            newRowId = db.insert(AppuserTable.TABLE_NAME, null, values);
        }
        return newRowId != -1;
    }
    ...
    public boolean importUserposition(Position position){
        ...
        if (position != null) {
            ...
            newRowId = db.insert(UserpositionTable.TABLE_NAME, null, values);
        }
        return newRowId != -1;
    }
    ...
    public boolean importMaps(ArrayList<Map> maps){
        ...
        if (maps != null) {
            ...
            for (Map map : maps) {
                ...
                newRowId = db.insert(MapTable.TABLE_NAME, null, values);
            }
        }
        return newRowId != -1;
    }
    ...
    public boolean importNodes(ArrayList<Node> nodes){
        ...
        if (nodes != null) {
            ...
            for (Node node : nodes) {
                ...
                newRowId = db.insert(NodeTable.TABLE_NAME, null, values);
            }
        }
        return newRowId != -1;
    }
    ...
    public boolean importEnviromentalValues(ArrayList<EnviromentalValues> envValues){
        ...
        if (envValues != null) {
            ...
            for (EnviromentalValues envValue : envValues) {
                ...
                newRowId = db.insert(EnviromentalvaluesTable.TABLE_NAME, null, values);
            }
        }
        return newRowId != -1;
    }
    ...
    public boolean isDbEmpty(){
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM " + AppuserTable.TABLE_NAME, null);
